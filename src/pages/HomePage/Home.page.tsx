            ...
            <div className="min-h-screen flex items-center">
                <div className="container mx-auto px-6 flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-1/2 flex justify-center items-center mt-8 md:mt-0">
                        <img src="https://raw.githubusercontent.com/DevWikz/wikz-web-app/gh-pages/images/hero-img.png" alt="Mobile App" className="w-1/2 h-auto md:w-2/3" />
                    </div>
                </div>
            ...
            <div className="w-full px-6 py-12">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start">
                    ...
                    <div className="w-full lg:w-2/4 flex justify-center items-center lg:mr-8 mt-12 lg:mt-0">
                        <img src="https://raw.githubusercontent.com/DevWikz/wikz-web-app/gh-pages/images/swag-img.png" alt="Mobile App" className="w-full h-auto" />
                    </div>
