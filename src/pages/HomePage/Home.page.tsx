    ...
    return (
        <>
            <div className='min-h-screen flex items-center'>
                <div className="container mx-auto px-6 flex flex-col md:flex-row mt-32 md:mt-36">
                    {/* Sol Taraf */}
                    <div className="w-full md:w-2/3 flex flex-col justify-center space-y-8">
                        <h1 className="text-3xl md:text-5xl font-extrabold text-white text-center md:text-start">
                            Are You Ready for Telegram's <br />
                            Ultimate Online Store?
                        </h1>
                        <div className="bg-[#111e55] text-white p-3 md:p-10 rounded-3xl shadow-lg text-center md:text-start">
            ...
            <div className="px-5 py-5 md:px-24 md:py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-1xl md:text-3xl font-bold mt-0 md:mt-2" style={{ color: '#5371ff' }}>
                        Your Hub for Exclusive Web3 Swag
                    </h2>
                    <div className="text-center mt-0 md:mt-12">
                        <p className="text-lg md:text-xl font-bold text-white">On the journey to becoming the premier swag store for the Web3 community</p>
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 sm:grid-cols-2">
                            ...
                            <div className="bg-[#1a2024] text-white p-2 rounded-[1rem] shadow-lg flex justify-center items-center">
                                <div className="text-center">
                                    ...
                                    <p className='text-[10px] md:text-[15px]'>Exclusive items directly from top crypto brands' stores,<br /> hosted on WikZ Swag.</p>
                                </div>
                            </div>
                            {/* 2.Kart */}
                            <div className="bg-[#1a2024] text-white p-2 rounded-[1rem] shadow-lg flex justify-center items-center">
                            ...
                            <div className="bg-[#1a2024] text-white p-2 rounded-[1rem] shadow-lg flex justify-center items-center">
                                <div className="text-center">
                                    ...
                                    <p className='text-[10px] md:text-[15px]'>Pay easily with major<br /> cryptocurrencies or traditional <br /> methods.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div className="px-5 py-5 md:px-24 md:py-12">
                <div className="text-center mb-12">
                    ...
                    <div className="text-center mt-0 md:mt-12">
                        <p className="text-lg md:text-xl font-bold text-white">WikZ Digital simplifies your digital life, keeping everything you need right at your fingertips within Telegram</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start">
                    ...
                    <div className="w-full lg:w-1/2 space-y-8 p-0 md:p-10 order-2 lg:order-1">
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="flex flex-col justify-center items-center bg-[#1a2024] text-white p-2 md:p-4 rounded-[1rem] shadow-lg text-center">
                                <h3 className="text-xs md:text-xl font-bold mb-2" style={{ color: '#5371ff' }}>E-SIM Solutions</h3>
